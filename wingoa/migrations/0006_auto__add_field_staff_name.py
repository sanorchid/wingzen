...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.name'
        db.add_column(u'wingoa_staff', 'name',
                      self.gf('django.db.models.fields.CharField')(default=12, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.name'
        db.delete_column(u'wingoa_staff', 'name')
