...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'wingoa_staff', 'rank',
                      self.gf('django.db.models.fields.CharField')(default=1984, max_length=10),
                      keep_default=False)
    ...
    models = {
        ...
        u'wingoa.staff': {
            ...
            'department': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['wingoa.Department']", 'max_length': '20', 'symmetrical': 'False'}),
            'graduate': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'major': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'position': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['wingoa.Position']", 'max_length': '10', 'symmetrical': 'False'}),
            'rank': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['wingoa.Rank']", 'max_length': '10', 'symmetrical': 'False'}),
