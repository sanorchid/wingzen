...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Staff.rank'
        db.alter_column(u'wingoa_staff', 'rank', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Staff.position'
        db.alter_column(u'wingoa_staff', 'position', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Staff.rank'
        db.alter_column(u'wingoa_staff', 'rank', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Staff.position'
        db.alter_column(u'wingoa_staff', 'position', self.gf('django.db.models.fields.CharField')(max_length=15))
