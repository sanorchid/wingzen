...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KlsWing'
        db.create_table(u'wingoa_klswing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inst', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wingoa.Inst'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='20')),
            ('room', self.gf('django.db.models.fields.CharField')(max_length='30')),
        ))
        db.send_create_signal(u'wingoa', ['KlsWing'])


    def backwards(self, orm):
        # Deleting model 'KlsWing'
        db.delete_table(u'wingoa_klswing')
