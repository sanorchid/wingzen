...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Inst'
        db.create_table(u'wingoa_inst', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='30')),
        ))
        db.send_create_signal(u'wingoa', ['Inst'])

        # Adding field 'Staff.inst'
        db.add_column(u'wingoa_staff', 'inst',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1992, to=orm['wingoa.Inst']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Inst'
        db.delete_table(u'wingoa_inst')

        # Deleting field 'Staff.inst'
        db.delete_column(u'wingoa_staff', 'inst_id')
    ...
    models = {
        ...
        u'wingoa.staff': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inst': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wingoa.Inst']"}),
            'is_quit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
